...
The authoritative source catalogue is `sources/catalogue.yaml`. Domain manifests and other inventory views must remain consistent with that catalogue and preserve stable source IDs.
