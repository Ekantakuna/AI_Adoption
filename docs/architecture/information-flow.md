...
| Relationships and impact | Structured IDs and typed links | Validated relationship records and derived affected-object views | Relationship schema, ADR-0011 semantics, and relationship/impact validation | Partial; bounded explicit-reference traversal is implemented with approved exit gates and no production `REL` records |
